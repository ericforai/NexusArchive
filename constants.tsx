...
export const NAV_ITEMS: NavItem[] = [
  { id: ViewState.PORTAL, label: '档案门户', icon: LayoutDashboard },
  { id: ViewState.PRE_ARCHIVE, label: '预归档库', icon: Layers, subItems: ['电子凭证池', 'OCR识别', '凭证关联'] },
  { id: ViewState.COLLECTION, label: '资料收集', icon: FileInput, subItems: ['在线接收', '扫描集成', '批量上传'] },
  { 
    ...
    subCategories: [
      {
        label: '整理',
        items: ['组卷成册', '档号自动生成', '四性检测', '业务完整性检索', '整理筛选']
      },
      {
        label: '归档',
        items: ['归档审批', '归档查看', '关联查看', '会计凭证', '会计账簿', '财务报告', '其他会计资料']
      },
      {
        label: '管理',
        items: ['档案装盒', '开放鉴定', '销毁鉴定', '开放清册', '销毁清册', '销毁库']
      }
    ]
  },
  { id: ViewState.QUERY, label: '档案查询', icon: Search, subItems: ['穿透联查', '全文检索'] },
  { id: ViewState.BORROWING, label: '档案借阅', icon: BookOpenCheck, subItems: ['借阅审批', '水印预览'] },
  { id: ViewState.WAREHOUSE, label: '库房管理', icon: Warehouse, subItems: ['密集架控制', '温湿度监控'] },
  { id: ViewState.STATS, label: '数据统计', icon: BarChart3 },
  { id: ViewState.SETTINGS, label: '系统设置', icon: Settings },
];
...
export const PRE_ARCHIVE_LINK_CONFIG: ModuleConfig = {
  ...
  data: [
    { id: '1', voucherNo: 'JZ-202310-0051', invoiceCount: '3 张', contractNo: 'CON-2023-098', matchScore: 100, autoLink: '自动规则', status: '已关联' },
    { id: '2', voucherNo: 'JZ-202310-0052', invoiceCount: '1 张', contractNo: '-', matchScore: 95, autoLink: '自动规则', status: '已关联' },
    { id: '3', voucherNo: 'JZ-202310-0053', invoiceCount: '0 张', contractNo: '-', matchScore: 0, autoLink: '-', status: '未关联' },
  ]
};
...
export const ACCOUNTING_VOUCHER_CONFIG: ModuleConfig = {
  ...
  data: [
    { id: '1', voucherNo: 'JZ-202311-0051', entity: '总公司', period: '11月', subject: '1002 银行存款', type: '付款凭证', amount: '¥ 45,200.00', date: '2023-11-03', status: '已归档' },
    { id: '2', voucherNo: 'JZ-202311-0052', entity: '分公司A', period: '11月', subject: '5001 主营业务收入', type: '收款凭证', amount: '¥ 125,000.00', date: '2023-11-02', status: '已归档' },
    { id: '3', voucherNo: 'JZ-202311-0053', entity: '总公司', period: '11月', subject: '6001 主营业务成本', type: '转账凭证', amount: '¥ 28,500.00', date: '2023-11-01', status: '已归档' },
    { id: '4', voucherNo: 'JZ-202310-0098', entity: '分公司B', period: '10月', subject: '2001 短期借款', type: '收款凭证', amount: '¥ 500,000.00', date: '2023-10-28', status: '已归档' },
    { id: '5', voucherNo: 'JZ-202310-0095', entity: '总公司', period: '10月', subject: '1001 库存现金', type: '付款凭证', amount: '¥ 5,600.00', date: '2023-10-25', status: '已归档' },
  ]
};
...
export const ACCOUNTING_LEDGER_CONFIG: ModuleConfig = {
  ...
  data: [
    { id: '1', ledgerNo: 'ZB-2023-001', type: '总账', entity: '总公司', year: '2023', period: '全年', subject: '全部科目', pageCount: '120', status: '已归档' },
    { id: '2', ledgerNo: 'ZB-2023-002', type: '明细账', entity: '总公司', year: '2023', period: '全年', subject: '1002 银行存款', pageCount: '45', status: '已归档' },
    { id: '3', ledgerNo: 'ZB-2023-003', type: '固定资产卡片', entity: '总公司', year: '2023', period: '全年', subject: '固定资产', pageCount: '28', status: '已归档' },
    { id: '4', ledgerNo: 'ZB-2023-004', type: '现金日记账', entity: '总公司', year: '2023', period: '全年', subject: '1001 库存现金', pageCount: '36', status: '已归档' },
    { id: '5', ledgerNo: 'ZB-2023-005', type: '银行存款日记账', entity: '总公司', year: '2023', period: '全年', subject: '1002 银行存款', pageCount: '52', status: '已归档' },
    { id: '6', ledgerNo: 'ZB-2023-006', type: '明细账', entity: '分公司A', year: '2023', period: '全年', subject: '5001 主营业务收入', pageCount: '38', status: '已归档' },
  ]
};
...
export const FINANCIAL_REPORT_CONFIG: ModuleConfig = {
  ...
  data: [
    { id: '1', reportNo: 'REP-2023-01', type: '月度报告', year: '2023', unit: '总公司', title: '2023年1月财务月报', period: '2023-01', status: '已归档' },
    { id: '2', reportNo: 'REP-2023-Q1', type: '季度报告', year: '2023', unit: '总公司', title: '2023年第一季度财务报告', period: '2023-Q1', status: '已归档' },
    { id: '3', reportNo: 'REP-2023-H1', type: '半年度报告', year: '2023', unit: '总公司', title: '2023年半年度财务报告', period: '2023-H1', status: '已归档' },
    { id: '4', reportNo: 'REP-2023-ANNUAL', type: '年度报告', year: '2023', unit: '总公司', title: '2023年度财务决算报告', period: '2023', status: '已归档' },
    { id: '5', reportNo: 'REP-2023-10', type: '月度报告', year: '2023', unit: '分公司A', title: '2023年10月财务月报', period: '2023-10', status: '已归档' },
  ]
};
