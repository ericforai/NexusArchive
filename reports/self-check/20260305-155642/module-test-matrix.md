...
- 生成时间: 2026-03-05T07:58:22.169Z
- 模块总数: 41
- 有测试映射: 41
- 无测试映射: 0
- 状态分布: passed=41, failed=0, mapped_not_run=0, uncovered=0, skipped_only=0
...
| component.settings | passed | 1 | 1 | 0 | `src/components/settings/manifest.config.ts` |
| component.table | passed | 4 | 4 | 0 | `src/components/table/manifest.config.ts` |
| component.voucher | passed | 1 | 1 | 0 | `src/components/voucher/manifest.config.ts` |
...
| feature.integration-settings | passed | 1 | 1 | 0 | `src/components/settings/integration/manifest.config.ts` |
| feature.settings | passed | 1 | 1 | 0 | `src/features/settings/manifest.config.ts` |
...
| page.settings | passed | 1 | 1 | 0 | `src/pages/settings/manifest.config.ts` |
