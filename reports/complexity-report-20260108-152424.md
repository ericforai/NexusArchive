...
**生成时间**: `2026-01-08 15:24:27`
**报告版本**: `20260108-152424`
...
| 层级 | 状态 | 违规数 | 详情 |
|------|------|--------|------|
| **前端 (React/TypeScript)** | ✅ 通过 | 633 | [查看详细 JSON](reports/complexity-report-20260108-152424.json) |
| **后端 (Java/Spring)** | ⚠️ 测试失败 | 0 | [查看 ArchUnit 输出](reports/archunit-backend-20260108-152424.txt) |
