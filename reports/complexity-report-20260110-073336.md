...
**生成时间**: `2026-01-10 07:33:41`
**报告版本**: `20260110-073336`
...
| 层级 | 状态 | 违规数 | 详情 |
|------|------|--------|------|
| **前端 (React/TypeScript)** | ✅ 通过 | 728 | [查看详细 JSON](reports/complexity-report-20260110-073336.json) |
| **后端 (Java/Spring)** | ⚠️ 测试失败 | 0 | [查看 ArchUnit 输出](reports/archunit-backend-20260110-073336.txt) |
