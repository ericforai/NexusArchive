...
**生成时间**: `2026-01-08 19:00:10`
**报告版本**: `20260108-190007`
...
| 层级 | 状态 | 违规数 | 详情 |
|------|------|--------|------|
| **前端 (React/TypeScript)** | ✅ 通过 | 552 | [查看详细 JSON](reports/complexity-report-20260108-190007.json) |
| **后端 (Java/Spring)** | ⚠️ 测试失败 | 1 | [查看 ArchUnit 输出](reports/archunit-backend-20260108-190007.txt) |
