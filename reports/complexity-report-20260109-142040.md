...
**生成时间**: `2026-01-09 14:20:43`
**报告版本**: `20260109-142040`
...
| 层级 | 状态 | 违规数 | 详情 |
|------|------|--------|------|
| **前端 (React/TypeScript)** | ✅ 通过 | 727 | [查看详细 JSON](reports/complexity-report-20260109-142040.json) |
| **后端 (Java/Spring)** | ⚠️ 测试失败 | 0 | [查看 ArchUnit 输出](reports/archunit-backend-20260109-142040.txt) |
