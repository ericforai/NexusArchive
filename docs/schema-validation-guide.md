...
```bash
# 在 docker-compose.dev.yml 中临时设置
...
docker-compose -f docker-compose.dev.yml up -d --force-recreate nexus-backend

# 查看验证结果
docker logs nexus-backend-dev --tail 100 | grep -i "schema validator"
