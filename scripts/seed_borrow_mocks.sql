...
INSERT INTO acc_borrow_request (
    ...
    'mock-req-001', 'BR-20260113-M001', 'user-1', '测试用户', 'dept-1', '研发部',
...
INSERT INTO acc_borrow_request (
    ...
    'mock-req-002', 'BR-20260113-M002', 'user-2', '李财务', 'dept-2', '财务部',
    '审计抽查：支付凭证与合同比对', 'AUDIT', CURRENT_DATE, CURRENT_DATE + 14,
...
INSERT INTO acc_borrow_request (
    ...
    'mock-req-003', 'BR-20260112-M003', 'user-1', '测试用户', 'dept-1', '研发部',
...
INSERT INTO acc_borrow_request (
    ...
    'mock-req-004', 'BR-20260110-M004', 'user-3', '王审计', 'dept-3', '审计部',
    '年度总账现场审计', 'ORIGINAL', CURRENT_DATE - 3, CURRENT_DATE + 27,
...
INSERT INTO acc_borrow_request (
    ...
    'mock-req-005', 'BR-20260105-M005', 'user-1', '测试用户', 'dept-1', '研发部',
...
INSERT INTO acc_borrow_request (
    ...
    'mock-req-006', 'BR-20260101-M006', 'user-4', '张实习', 'dept-1', '研发部',
