import{c as s,X as r,j as e,Y as n,Z as c,_ as l}from"./index-DFQIp-y2.js";import{S as h}from"./shield-DyJqvUgo.js";import{L as d}from"./lock-BvbV9iNo.js";/**
 ...
 */const u=[["path",{d:"M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2",key:"1yyitq"}],["path",{d:"M16 3.128a4 4 0 0 1 0 7.744",key:"16gr8j"}],["path",{d:"M22 21v-2a4 4 0 0 0-3-3.87",key:"kshegd"}],["circle",{cx:"9",cy:"7",r:"4",key:"nufk8"}]],v=s("users",u),f=[{key:"basic",label:"基础设置",path:"/system/settings/basic",icon:n},{key:"users",label:"用户管理",path:"/system/settings/users",icon:v},{key:"roles",label:"角色权限",path:"/system/settings/roles",icon:h},{key:"org",label:"组织架构",path:"/system/settings/org",icon:y},{key:"fonds",label:"全宗管理",path:"/system/settings/fonds",icon:b},{key:"security",label:"安全合规",path:"/system/settings/security",icon:d},{key:"audit",label:"审计日志",path:"/system/settings/audit",icon:x}],N=()=>{const t=r();return e.jsxs("div",{className:"min-h-full bg-slate-50",children:[e.jsxs("div",{className:"bg-white border-b border-slate-200 px-8 py-6",children:[e.jsx("h1",{className:"text-2xl font-bold text-slate-800",children:"系统设置"}),e.jsx("p",{className:"text-slate-500 mt-1",children:"配置全局参数、用户权限及安全策略"})]}),e.jsx("div",{className:"bg-white border-b border-slate-200 px-8",children:e.jsx("nav",{className:"flex space-x-1 overflow-x-auto","aria-label":"设置导航",children:f.map(a=>{const o=t.pathname===a.path||a.key==="basic"&&t.pathname==="/system/settings",i=a.icon;return e.jsxs(c,{to:a.path,className:`
                ...
                `,children:[e.jsx(i,{size:16,className:"mr-2"}),a.label]},a.key)})})}),e.jsx("div",{className:"p-8 max-w-5xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-300",children:e.jsx(l,{})})]})};export{N as SettingsLayout,N as default};
