...
// Output: Minimal self-verify guard for module page.demo
// Pos: Self-verifying tests - module baseline
// @manifest:page.demo

import { describe, expect, it } from 'vitest';
import { moduleManifest } from '../../../pages/demo/manifest.config';

describe('self-verify: page.demo', () => {
  it('manifest contract should be stable', () => {
    expect(moduleManifest.id).toBe('page.demo');
