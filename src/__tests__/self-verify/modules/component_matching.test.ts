...
// Output: Minimal self-verify guard for module component.matching
// Pos: Self-verifying tests - module baseline
// @manifest:component.matching

import { describe, expect, it } from 'vitest';
import { moduleManifest } from '../../../components/matching/manifest.config';

describe('self-verify: component.matching', () => {
  it('manifest contract should be stable', () => {
    expect(moduleManifest.id).toBe('component.matching');
