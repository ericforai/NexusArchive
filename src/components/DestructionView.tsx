         ...
         <div className="relative z-10 max-w-[1600px] mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mt-8">
               <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/10">
                  ...
                  <div className="text-3xl font-bold">1,245 <span className="text-xs font-normal text-slate-400">件</span></div>
               </div>
               <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/10">
                  <div className="flex justify-between items-start mb-2">
                  ...
                  <div className="text-3xl font-bold text-rose-400">892 <span className="text-xs font-normal text-white">件</span></div>
               </div>
               <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/10">
                  <div className="flex justify-between items-start mb-2">
                  ...
                  <div className="text-3xl font-bold">2 <span className="text-xs font-normal text-slate-400">批</span></div>
               </div>
               <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/10">
                  <div className="flex justify-between items-start mb-2">
                  ...
                  <div className="text-3xl font-bold">15.4 <span className="text-xs font-normal text-slate-400">万件</span></div>
               </div>
            </div>
         </div>
      </div>
