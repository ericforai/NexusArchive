...
const REG_LIST = [
    {
        ...
        source: '国家档案局',
        category: '核心规范',
        desc: '电子会计档案管理的“宪法”，定义了四性检测要求及电子凭证的法律等效性。'
    },
    {
        ...
        source: '国家档案局',
        category: '行业标准',
        desc: '2024 年最新发布，规定了 ERP 系统中记账凭证、采购订单、物料凭证等归档范围。'
    },
    {
        slug: 'dat-95-spec',
        ...
        source: '国家档案局',
        category: '技术规范',
        desc: '聚焦行政事业单位，规范电子发票采集、查验、预览及归档的全生命周期。'
    },
    {
        ...
        source: '国家标准',
        category: '通用标准',
        desc: '规定了电子档案管理系统应具备的收集、整理、保存、利用等 8 大核心功能模块。'
    }
];
