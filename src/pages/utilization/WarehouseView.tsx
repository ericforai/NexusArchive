...
export const WarehouseView: React.FC = () => {
  ...
  return (
    <div className="h-full flex flex-col bg-slate-50 animate-in fade-in duration-500 relative">
      {error && (
        ...
        <div className="flex items-center gap-4 border-l border-slate-100 pl-6">
          ...
          <div>
            ...
            <p className="text-xl font-bold text-slate-800">
              ...
              <span className="text-xs font-normal text-emerald-600 bg-emerald-50 px-1.5 py-0.5 rounded ml-1">
                {environment?.status || '监控中'}
              </span>
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-4 border-l border-slate-100 pl-6">
          ...
          <div>
            ...
            <p className="text-xl font-bold text-slate-800">
              ...
              <span className="text-xs font-normal text-emerald-600 bg-emerald-50 px-1.5 py-0.5 rounded ml-1">正常</span>
            </p>
          </div>
        </div>
      ...
      {/* Visual Layout */}
      <div className="flex-1 p-8 overflow-hidden flex gap-8 relative">
        {loading && (
          <div className="absolute inset-0 bg-white/70 backdrop-blur-sm flex items-center justify-center z-20">
            <div className="flex items-center gap-2 text-slate-600 text-sm">
              <Loader2 className="animate-spin" size={18} /> 正在刷新库房数据...
            </div>
          </div>
        )}
