...
\restrict ANNuclzFqwbMl953qtgDnE6euWhXDdSVkc2ukBexGzHg5g3XRldGnpTJUU2BVe2
...
CREATE TABLE public.collection_batch (
    ...
    last_modified_time timestamp without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
    completed_time timestamp without time zone,
    CONSTRAINT chk_collection_batch_status CHECK (((status)::text = ANY ((ARRAY['UPLOADING'::character varying, 'UPLOADED'::character varying, 'VALIDATING'::character varying, 'VALIDATED'::character varying, 'FAILED'::character varying, 'ARCHIVED'::character varying])::text[])))
);
...
CREATE TABLE public.collection_batch_file (
    ...
    CONSTRAINT chk_upload_status CHECK (((upload_status)::text = ANY ((ARRAY['PENDING'::character varying, 'UPLOADING'::character varying, 'UPLOADED'::character varying, 'FAILED'::character varying, 'DUPLICATE'::character varying, 'VALIDATING'::character varying, 'VALIDATED'::character varying, 'CHECK_FAILED'::character varying])::text[])))
);
...
attach-link-003	voucher-2024-11-003	file-invoice-003	bank_slip	银行回单	system	2025-12-28 09:03:35.017527	2026-01-14 18:54:06.830786
...
1	1	init baseline 2025	SQL	V1__init_baseline_2025.sql	-811615317	postgres	2026-01-14 18:54:05.583067	999	t
...
1	用友 YonSuite	YONSUITE	{"baseUrl": "https://dbox.yonyoucloud.com/iuap-api-gateway", "appKey": "96a95c00982446cba484ccc4936b221b", "appSecret": "e9a58fd35f3ca3f0a46d27b8859758b1ed35f0b6", "accbookCode": "BR01", "extraConfig": ""}	1	2025-12-28 09:03:34.854164	2025-12-28 09:03:34.854164	{"BR01": "BR01"}	\N
2	SAP ERP	SAP	{"system": "SAP ERP", "frequency": "实时", "description": "SAP 财务凭证自动同步接口"}	1	2025-12-28 09:03:34.854164	2025-12-28 09:03:34.854164	\N	\N
3	金蝶云星空	KINGDEE	{"system": "金蝶云星空", "frequency": "每日 23:00", "description": "存货核算数据同步"}	1	2025-12-28 09:03:34.854164	2025-12-28 09:03:34.854164	\N	\N
4	泛微 OA	WEAVER	{"system": "泛微OA", "frequency": "每小时", "description": "员工报销单据同步"}	1	2025-12-28 09:03:34.854164	2025-12-28 09:03:34.854164	\N	\N
5	易快报	GENERIC	{"system": "易快报", "frequency": "每小时", "description": "差旅费用数据同步"}	1	2025-12-28 09:03:34.854164	2025-12-28 09:03:34.854164	\N	\N
\.
...
6	1	VOUCHER_SYNC	凭证同步	从用友YonSuite同步记账凭证	t	MANUAL	\N	2025-12-26 14:30:00	SUCCESS	同步成功，获取100条凭证	2025-12-20 10:00:00	2025-12-26 14:30:00	\N
...
13	1	ATTACHMENT_SYNC	凭证附件同步	从用友YonSuite同步凭证附件文件	t	MANUAL	\N	\N	\N	\N	2025-12-20 10:00:00	2025-12-20 10:00:00	\N
14	1	COLLECTION_FILE_SYNC	收款文件同步	从用友YonSuite同步收款相关文件	t	MANUAL	\N	\N	\N	\N	2025-12-20 10:00:00	2025-12-20 10:00:00	\N
15	1	PAYMENT_FILE_SYNC	付款文件同步	从用友YonSuite同步付款相关文件	t	MANUAL	\N	\N	\N	\N	2025-12-20 10:00:00	2025-12-20 10:00:00	\N
16	1	REFUND_FILE_SYNC	退款文件同步	从用友YonSuite同步退款相关文件	t	MANUAL	\N	\N	\N	\N	2025-12-20 10:00:00	2025-12-20 10:00:00	\N
...
role_system_admin	系统管理员	system_admin	system_admin	t	负责系统运维和配置管理（三员分立之一）	["nav:portal","nav:settings","manage_settings","system:backup","system:restore","system:monitor","archive:read","archive:view","audit:view"]	all	system	2026-01-14 18:56:36.518649	2026-01-14 18:56:36.518649	0	2026-01-14 18:56:36.518649
...
CREATE UNIQUE INDEX idx_collection_batch_file_batch_name ON public.collection_batch_file USING btree (batch_id, original_filename) WHERE ((upload_status)::text <> ALL ((ARRAY['FAILED'::character varying, 'DUPLICATE'::character varying])::text[]));
...
\unrestrict ANNuclzFqwbMl953qtgDnE6euWhXDdSVkc2ukBexGzHg5g3XRldGnpTJUU2BVe2
