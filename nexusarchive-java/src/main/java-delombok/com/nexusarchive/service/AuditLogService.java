...
public class AuditLogService {
    ...
    public static class LogChainVerifyResult {
        ...
        public int getVerifiedLogs() { return verifiedLogs; }
        public String getMessage() { return message; }

        // Manual Builder
        public static LogChainVerifyResultBuilder builder() { return new LogChainVerifyResultBuilder(); }
        public static class LogChainVerifyResultBuilder {
            private boolean valid;
            private int totalLogs;
            private int verifiedLogs;
            private String message;
            public LogChainVerifyResultBuilder valid(boolean valid) { this.valid = valid; return this; }
            public LogChainVerifyResultBuilder totalLogs(int totalLogs) { this.totalLogs = totalLogs; return this; }
            public LogChainVerifyResultBuilder verifiedLogs(int verifiedLogs) { this.verifiedLogs = verifiedLogs; return this; }
            public LogChainVerifyResultBuilder message(String message) { this.message = message; return this; }
            public LogChainVerifyResult build() {
                LogChainVerifyResult r = new LogChainVerifyResult();
                r.valid = this.valid; r.totalLogs = this.totalLogs; r.verifiedLogs = this.verifiedLogs; r.message = this.message;
                return r;
            }
        }
    }
