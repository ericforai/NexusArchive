...
public class Archive {
    ...
    public java.time.LocalDate getRetentionStartDate() { return retentionStartDate; }
    ...
    public String getFixityAlgo() { return fixityAlgo; }
    public String getUniqueBizId() { return uniqueBizId; }
    public java.math.BigDecimal getAmount() { return amount; }
    public java.time.LocalDate getDocDate() { return docDate; }
    public String getVolumeId() { return volumeId; }
    public LocalDateTime getCreatedTime() { return createdTime; }
    public LocalDateTime getLastModifiedTime() { return lastModifiedTime; }
    public String getPaperRefLink() { return paperRefLink; }
    public Boolean getDestructionHold() { return destructionHold; }
    public String getHoldReason() { return holdReason; }
    public Integer getMatchScore() { return matchScore; }
    public String getDestructionStatus() { return destructionStatus; }
    public String getMatchMethod() { return matchMethod; }
    public String getStandardMetadata() { return standardMetadata; }
}
