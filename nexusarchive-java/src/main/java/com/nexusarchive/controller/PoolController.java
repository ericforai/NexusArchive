...
public class PoolController {
    ...
    /**
     * 按状态查询预归档文件
     * @param status 状态: PENDING_CHECK/CHECK_FAILED/PENDING_METADATA/PENDING_ARCHIVE/ARCHIVED
     * @return 文件列表
     */
    ...
    public Result<java.util.Map<String, Long>> getStatusStats() {
        ...
        String[] statuses = {"PENDING_CHECK", "CHECK_FAILED", "PENDING_METADATA", "PENDING_ARCHIVE", "PENDING_APPROVAL", "ARCHIVED"};
