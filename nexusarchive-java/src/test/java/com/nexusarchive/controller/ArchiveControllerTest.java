...
// Output: ArchiveControllerTest 测试用例类
// Pos: 后端测试用例
...
@org.springframework.boot.test.autoconfigure.web.servlet.WebMvcTest(value = ArchiveController.class, excludeFilters = @org.springframework.context.annotation.ComponentScan.Filter(type = org.springframework.context.annotation.FilterType.ASSIGNABLE_TYPE, classes = {
...
public class ArchiveControllerTest {
        ...
        public void setup() {
                ...
                org.mockito.Mockito.when(jwtUtil.validateToken(org.mockito.ArgumentMatchers.anyString()))
                                .thenReturn(true);
                org.mockito.Mockito.when(jwtUtil.extractUsername(org.mockito.ArgumentMatchers.anyString()))
                                .thenReturn("admin");
                ...
                org.mockito.Mockito.when(jwtUtil.extractAllClaims(org.mockito.ArgumentMatchers.anyString()))
                                .thenReturn(claims);
        ...
        public void testArchiveCrud() throws Exception {
                ...
                org.mockito.Mockito.doNothing().when(archiveService).updateArchive(
                                org.mockito.ArgumentMatchers.eq(archiveId),
